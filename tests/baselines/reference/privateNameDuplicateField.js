...
function Field() {
    ...
    _A_Field_Field_foo = new WeakMap();
    // Error
    class A_Field_Method {
        #foo = "foo";
        #foo() { }
...
function Method() {
    ...
    _b = A_Method_StaticMethod;
    // Error
    class A_Method_StaticGetter {
        #foo() { }
        static get #foo() { return ""; }
    }
    _c = A_Method_StaticGetter;
    // Error
    class A_Method_StaticSetter {
        #foo() { }
        static set #foo(value) { }
    }
    _d = A_Method_StaticSetter;
}
function Getter() {
    ...
    _a = A_Getter_StaticField;
    // Error
    class A_Getter_StaticMethod {
        get #foo() { return ""; }
        static #foo() { }
    }
    _b = A_Getter_StaticMethod;
    // Error
    class A_Getter_StaticGetter {
        get #foo() { return ""; }
        static get #foo() { return ""; }
    }
    _c = A_Getter_StaticGetter;
    // Error
    class A_Getter_StaticSetter {
        get #foo() { return ""; }
        static set #foo(value) { }
    }
    _d = A_Getter_StaticSetter;
}
function Setter() {
    ...
    _b = A_Setter_StaticMethod;
    // Error
    class A_Setter_StaticGetter {
        set #foo(value) { }
        static get #foo() { return ""; }
    }
    _c = A_Setter_StaticGetter;
    // Error
    class A_Setter_StaticSetter {
        set #foo(value) { }
        static set #foo(value) { }
    }
    _d = A_Setter_StaticSetter;
}
function StaticField() {
    ...
    _b = A_StaticField_Method;
    // Error
    class A_StaticField_Getter {
        static #foo = "foo";
        get #foo() { return ""; }
    }
    _c = A_StaticField_Getter;
    // Error
    class A_StaticField_Setter {
        static #foo = "foo";
        set #foo(value) { }
    }
    _d = A_StaticField_Setter;
    // Error
    class A_StaticField_StaticField {
        static #foo = "foo";
        static #foo = "foo";
...
function StaticMethod() {
    ...
    _a = A_StaticMethod_Field;
    // Error
    class A_StaticMethod_Method {
        static #foo() { }
        #foo() { }
    }
    _b = A_StaticMethod_Method;
    // Error
    class A_StaticMethod_Getter {
        static #foo() { }
        get #foo() { return ""; }
    }
    _c = A_StaticMethod_Getter;
    // Error
    class A_StaticMethod_Setter {
        static #foo() { }
        set #foo(value) { }
...
function StaticGetter() {
    ...
    _b = A_StaticGetter_Method;
    // Error
    class A_StaticGetter_Getter {
        static get #foo() { return ""; }
        get #foo() { return ""; }
    }
    _c = A_StaticGetter_Getter;
    // Error
    class A_StaticGetter_Setter {
        static get #foo() { return ""; }
        set #foo(value) { }
    }
    _d = A_StaticGetter_Setter;
    // Error
    class A_StaticGetter_StaticField {
        static get #foo() { return ""; }
        static #foo() { }
...
function StaticSetter() {
    ...
    _a = A_StaticSetter_Field;
    // Error
    class A_StaticSetter_Method {
        static set #foo(value) { }
        #foo() { }
    }
    _b = A_StaticSetter_Method;
    // Error
    class A_StaticSetter_Getter {
        static set #foo(value) { }
        get #foo() { return ""; }
    }
    _c = A_StaticSetter_Getter;
    // Error
    class A_StaticSetter_Setter {
        static set #foo(value) { }
        set #foo(value) { }
